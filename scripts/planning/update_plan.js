...
// Update Git commit info at top
md = md.replace(
  /a93ccff fix: M5 bug fixes — session detail endpoint, runOnce execution, Playwright timeout/,
  `a0d73a0 fix: M5 — 修复快照文件访问 404 问题（双路径变量 + ResponseEntity<byte[]）`
);
